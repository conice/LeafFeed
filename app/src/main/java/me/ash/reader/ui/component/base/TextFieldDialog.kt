...
fun TextFieldDialog(
    ...
    RYDialog(
        ...
        confirmButton = {
            TextButton(
                enabled = value.isNotBlank() && confirmEnabled,
                onClick = {
                ...
                Text(
                    text = confirmText,
                    color =
                        if (value.isNotBlank() && confirmEnabled) {
                            Color.Unspecified
                        } else {
...
fun TextFieldDialog(
    ...
    RYDialog(
        ...
        confirmButton = {
            TextButton(
                enabled = textFieldState.text.isNotBlank() && confirmEnabled,
                onClick = {
                    focusManager.clearFocus()
                ...
                Text(
                    text = confirmText,
                    color =
                        if (textFieldState.text.isNotBlank() && confirmEnabled) {
                            Color.Unspecified
                        } else {
                            MaterialTheme.colorScheme.outline.copy(alpha = 0.7f)
                        },
