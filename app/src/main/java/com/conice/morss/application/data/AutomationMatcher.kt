...
import com.conice.morss.domain.model.article.AutomationCondition
...
private fun AutomationRule.appliesTo(candidate: AutomationCandidate): Boolean =
    accountId == candidate.accountId && when (scope) {
        com.conice.morss.domain.model.article.AutomationScope.GLOBAL -> true
        com.conice.morss.domain.model.article.AutomationScope.GROUP -> candidate.groupId in scopeIds
        com.conice.morss.domain.model.article.AutomationScope.FEED -> candidate.feedId in scopeIds
    }
