...
import com.conice.morss.infrastructure.preference.PreferencesKey.Companion.pullToLoadNextFeed
...
sealed class PullToLoadNextFeedPreference(val value: Int) : Preference() {
    ...
    companion object {
        ...
        fun fromPreference(preference: Preferences): PullToLoadNextFeedPreference {
            val value = preference.getPreference<Int>(pullToLoadNextFeed)
            return when (value) {
                0 -> None
                1 -> LoadNextFeed
