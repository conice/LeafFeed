...
import com.conice.morss.infrastructure.preference.PreferencesKey.Companion.feedsGroupListTonalElevation
...
sealed class FeedsGroupListTonalElevationPreference(val value: Int) : Preference() {
    ...
    companion object {
        ...
        fun fromPreferences(preferences: Preferences) =
            when (preferences.getPreference<Int>(feedsGroupListTonalElevation)) {
