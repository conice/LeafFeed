...
import com.conice.morss.infrastructure.preference.PreferencesKey.Companion.flowArticleListTime
...
sealed class FlowArticleListTimePreference(val value: Boolean) : Preference() {
    ...
    companion object {
        ...
        fun fromPreferences(preferences: Preferences) =
            when (preferences.getPreference<Boolean>(flowArticleListTime)) {
                true -> ON
                false -> OFF
                else -> default
            }
