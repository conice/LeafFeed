...
import com.conice.morss.infrastructure.preference.PreferencesKey.Companion.feedsFilterBarTonalElevation
...
sealed class FeedsFilterBarTonalElevationPreference(val value: Int) : Preference() {
    ...
    companion object {
        ...
        fun fromPreferences(preferences: Preferences) =
            when (preferences.getPreference<Int>(feedsFilterBarTonalElevation)) {
