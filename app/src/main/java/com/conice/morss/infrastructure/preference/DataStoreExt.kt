...
import com.conice.morss.infrastructure.ai.AiConfigurationBackup
import com.conice.morss.infrastructure.ai.AiConfigurationImportResult
    ...
    companion object {
        ...
        private val keyList =
            listOf(
                ...
                BooleanKey(
                    FeaturePreferenceKeys.markReadAtEnd.name,
                ...
                BooleanKey(
                    FeaturePreferenceKeys.showNotesAction.name,
                    FeaturePreferenceKeys.showNotesAction,
                ),
                BooleanKey(
                    FeaturePreferenceKeys.showReadLaterIcon.name,
                    FeaturePreferenceKeys.showReadLaterIcon,
                ),
                BooleanKey(
                    FeaturePreferenceKeys.preferFullContent.name,
                    FeaturePreferenceKeys.preferFullContent,
                ),
                BooleanKey(
                    FeaturePreferenceKeys.aiStreamingEnabled.name,
                ...
                // Podcasts
                FloatKey(
                    FeaturePreferenceKeys.podcastDefaultSpeed.name,
                    FeaturePreferenceKeys.podcastDefaultSpeed,
                ),
                IntKey(
                    FeaturePreferenceKeys.podcastRewindSeconds.name,
                    FeaturePreferenceKeys.podcastRewindSeconds,
                ),
                IntKey(
                    FeaturePreferenceKeys.podcastForwardSeconds.name,
                    FeaturePreferenceKeys.podcastForwardSeconds,
                ),
                BooleanKey(
                    FeaturePreferenceKeys.podcastAutoPlayNext.name,
                    FeaturePreferenceKeys.podcastAutoPlayNext,
                ),
                BooleanKey(
                    FeaturePreferenceKeys.podcastMarkPlayed.name,
                    FeaturePreferenceKeys.podcastMarkPlayed,
                ),
                BooleanKey(
                    FeaturePreferenceKeys.podcastRememberProgress.name,
                    FeaturePreferenceKeys.podcastRememberProgress,
                ),
                BooleanKey(
                    FeaturePreferenceKeys.podcastAutoDownload.name,
                    FeaturePreferenceKeys.podcastAutoDownload,
                ),
                BooleanKey(
                    FeaturePreferenceKeys.podcastWifiOnly.name,
                    FeaturePreferenceKeys.podcastWifiOnly,
                ),
                IntKey(
                    FeaturePreferenceKeys.podcastDownloadScope.name,
                    FeaturePreferenceKeys.podcastDownloadScope,
                ),
                IntKey(
                    FeaturePreferenceKeys.podcastCacheMb.name,
                    FeaturePreferenceKeys.podcastCacheMb,
                ),
                IntKey(
                    FeaturePreferenceKeys.podcastRetentionDays.name,
                    FeaturePreferenceKeys.podcastRetentionDays,
                ),
                BooleanKey(
                    FeaturePreferenceKeys.podcastAutoTranscript.name,
                    FeaturePreferenceKeys.podcastAutoTranscript,
                ),
                BooleanKey(
                    FeaturePreferenceKeys.podcastShowEpisodeMetadata.name,
                    FeaturePreferenceKeys.podcastShowEpisodeMetadata,
                ),
                // Notifications
                BooleanKey(
                    FeaturePreferenceKeys.notificationsEnabled.name,
                    FeaturePreferenceKeys.notificationsEnabled,
                ),
                IntKey(
                    FeaturePreferenceKeys.notificationMaxArticles.name,
                ...
                // Data and privacy
                IntKey(
                    FeaturePreferenceKeys.deduplicationMode.name,
                    FeaturePreferenceKeys.deduplicationMode,
                ),
                BooleanKey(
                    FeaturePreferenceKeys.cleanupConfirmation.name,
                    FeaturePreferenceKeys.cleanupConfirmation,
                ),
                BooleanKey(
                    FeaturePreferenceKeys.syncFullContent.name,
                    FeaturePreferenceKeys.syncFullContent,
                ),
                IntKey(
                    FeaturePreferenceKeys.aiContentScope.name,
                    FeaturePreferenceKeys.aiContentScope,
                ),
                BooleanKey(
                    FeaturePreferenceKeys.aiIncludeArticleLink.name,
...
private const val PREFERENCES_EXPORT_FORMAT = "morss.preferences"
