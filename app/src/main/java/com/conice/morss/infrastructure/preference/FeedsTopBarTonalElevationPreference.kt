...
import com.conice.morss.infrastructure.preference.PreferencesKey.Companion.feedsTopBarTonalElevation
...
sealed class FeedsTopBarTonalElevationPreference(val value: Int) : Preference() {
    ...
    companion object {
        ...
        fun fromPreferences(preferences: Preferences) =
            when (preferences.getPreference<Int>(feedsTopBarTonalElevation)) {
