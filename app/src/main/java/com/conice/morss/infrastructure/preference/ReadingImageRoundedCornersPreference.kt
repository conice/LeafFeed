...
import com.conice.morss.infrastructure.preference.PreferencesKey.Companion.readingImageRoundedCorners
...
object ReadingImageRoundedCornersPreference {
    ...
    fun fromPreferences(preferences: Preferences) =
        preferences.getPreference<Int>(readingImageRoundedCorners) ?: default
}
