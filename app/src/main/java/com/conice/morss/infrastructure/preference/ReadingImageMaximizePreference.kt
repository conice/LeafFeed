...
import com.conice.morss.infrastructure.preference.PreferencesKey.Companion.readingImageMaximize
...
sealed class ReadingImageMaximizePreference(val value: Boolean) : Preference() {
    ...
    companion object {
        ...
        fun fromPreferences(preferences: Preferences) =
            when (preferences.getPreference<Boolean>(readingImageMaximize)) {
                true -> ON
                false -> OFF
                else -> default
            }
