...
import com.conice.morss.infrastructure.preference.PreferencesKey.Companion.flowArticleListTonalElevation
...
sealed class FlowArticleListTonalElevationPreference(val value: Int) : Preference() {
    ...
    companion object {
        ...
        fun fromPreferences(preferences: Preferences) =
            when (preferences.getPreference<Int>(flowArticleListTonalElevation)) {
