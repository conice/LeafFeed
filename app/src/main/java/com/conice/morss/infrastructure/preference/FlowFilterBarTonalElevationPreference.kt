...
import com.conice.morss.infrastructure.preference.PreferencesKey.Companion.flowFilterBarTonalElevation
...
sealed class FlowFilterBarTonalElevationPreference(val value: Int) : Preference() {
    ...
    companion object {
        ...
        fun fromPreferences(preferences: Preferences) =
            when (preferences.getPreference<Int>(flowFilterBarTonalElevation)) {
