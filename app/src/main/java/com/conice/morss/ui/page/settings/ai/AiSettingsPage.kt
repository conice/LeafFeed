package com.conice.morss.ui.page.settings.ai
...
import com.conice.morss.domain.model.ai.AiOutputMode
import com.conice.morss.domain.model.ai.AiPrompt
import com.conice.morss.domain.model.ai.AiProvider
import com.conice.morss.domain.model.ai.AiTask
import com.conice.morss.domain.model.ai.DEFAULT_MAX_OUTPUT_TOKENS
...
internal fun AiAuthType.displayName(): String = when (this) {
...
internal fun AiTask.displayName(): String = when (this) {
