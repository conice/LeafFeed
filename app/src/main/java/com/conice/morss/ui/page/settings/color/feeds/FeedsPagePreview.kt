...
package com.conice.morss.ui.page.settings.color.feeds
...
import com.conice.morss.infrastructure.preference.FeedsGroupListExpandPreference
import com.conice.morss.infrastructure.preference.FeedsTopBarTonalElevationPreference
...
import com.conice.morss.ui.page.home.feeds.FeedItem
import com.conice.morss.ui.page.home.feeds.GroupItem
import com.conice.morss.ui.page.home.feeds.GroupWithFeedsContainer
    ...
    Column(
        ...
        GroupWithFeedsContainer {
            GroupItem(
                ...
                articleCount = if (filter.isAll() || filter.isUnread()) 100 else null,
            )
