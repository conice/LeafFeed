...
import com.conice.morss.ui.component.reader.ExpandedContentWidth
import com.conice.morss.ui.component.reader.LocalTextContentWidth
import com.conice.morss.ui.component.reader.MediumContentWidth
import com.conice.morss.ui.page.home.flow.FlowPage
import com.conice.morss.ui.page.home.reading.ReadingPage
...
fun ArticleListReaderPage(
    ...
    val backgroundTextMeasurementExecutor = remember {
        Executors.newSingleThreadExecutor()
    }
    DisposableEffect(backgroundTextMeasurementExecutor) {
        onDispose { backgroundTextMeasurementExecutor.shutdown() }
    }
    ...
    val paneExpansionState =
        rememberPaneExpansionState(
            ...
            anchoringAnimationSpec = MaterialTheme.motionScheme.defaultSpatialSpec(),
        )
    ...
    val animatedContentWidth by animateDpAsState(
        ...
        label = "readerContentWidth",
    )
    val animatedListAlpha by animateFloatAsState(
        targetValue = listAlpha,
        animationSpec = MaterialTheme.motionScheme.defaultEffectsSpec(),
        label = "readerListAlpha",
    )
            ...
            AnimatedPane(
                ...
                CompositionLocalProvider(
                    LocalBackgroundTextMeasurementExecutor provides
                        backgroundTextMeasurementExecutor
                ) {
