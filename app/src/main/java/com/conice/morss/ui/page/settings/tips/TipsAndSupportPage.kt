...
import com.conice.morss.ui.graphics.MorphPolygonShape
...
private fun RoundIconButton(type: RoundIconButtonType) {
    val iconColor = MaterialTheme.colorScheme.onSurface alwaysLight true
    val iconTint = if (
        type is RoundIconButtonType.Sponsor
    ) {
        iconColor.copy(alpha = 0.38f)
    } else {
        iconColor
    }
