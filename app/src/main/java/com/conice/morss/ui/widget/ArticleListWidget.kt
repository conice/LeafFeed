package com.conice.morss.ui.widget
...
import com.conice.morss.infrastructure.android.MainActivity
import com.conice.morss.ui.ext.collectAsStateValueWithoutLifecycle
...
class ArticleListWidget() : GlanceAppWidget() {
        ...
        get() =
            object : GlanceStateDefinition<Preferences> {
                override fun getLocation(context: Context, fileKey: String): File {
                    return context.preferencesDataStoreFile("widgets")
                }
    ...
    override suspend fun provideGlance(context: Context, id: GlanceId) {
        ...
        provideContent {
            val config = configFlow.collectAsStateValueWithoutLifecycle(initialConfig)
            val (theme, dataSource) = config

            val data =
                remember(dataSource) { repository.getData(dataSource) }
                    .collectAsStateValueWithoutLifecycle(initialData)
