package com.conice.morss.ui.component.swipe
...
fun rememberSwipeableActionsState(): SwipeableActionsState {
  ...
  return remember { SwipeableActionsState(resetAnimationSpec) }
}
...
class SwipeableActionsState internal constructor(
  private val resetAnimationSpec: AnimationSpec<Float>,
) {
  /**
   * The current position (in pixels) of a [SwipeableActionsBox].
   */
  val offset: State<Float> get() = offsetState
  internal val offsetState = mutableFloatStateOf(0f)
  ...
  private val isPastSwipeThreshold by derivedStateOf {
    abs(offsetState.value) > swipeThresholdPx
  }
