...
import com.conice.morss.infrastructure.ai.AiBindingBackup
import com.conice.morss.infrastructure.ai.AiConfigurationBackup
import com.conice.morss.infrastructure.ai.AiConnectionBackup
import com.conice.morss.infrastructure.ai.AiModelBackup
import com.conice.morss.infrastructure.ai.AiPromptBackup
...
import com.conice.morss.infrastructure.preference.decodePreferencesJSON
import com.conice.morss.infrastructure.preference.encodePreferencesJSON
import com.conice.morss.infrastructure.preference.isPreferenceExportable
...
class DataStoreExportTest {
    ...
    fun `encodes and decodes versioned preferences`() {
        ...
        assertTrue(encoded.contains("\"format\":\"morss.preferences\""))
